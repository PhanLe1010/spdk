...
static void
rpc_bdev_lvol_deep_copy_status_cb(uint64_t copied_clusters, uint64_t unmapped_clusters,
					 void *cb_arg)
{
	// struct rpc_shallow_copy_status *status = cb_arg;
	//
				 ...
				 const struct spdk_json_val *params)
{
	...
	//
	// spdk_json_write_object_begin(w);
	// spdk_json_write_named_string(w, "src_lvol_name", req.src_lvol_name);
	// spdk_json_write_named_string(w, "dst_bdev_name", req.dst_bdev_name);
	// spdk_json_write_object_end(w);
	//
	// spdk_jsonrpc_end_result(request, w);
	//////////////////////////////////////////
	...
	rc = vbdev_lvol_deep_copy(src_lvol, req.dst_bdev_name,
				     rpc_bdev_lvol_deep_copy_status_cb, NULL, // TODO: change this to: status
	...
	if (rc < 0) {
		...
		spdk_json_write_object_begin(w);
		spdk_json_write_named_uint32(w, "operation_id", 1); // TODO change this to status->operation_id
		spdk_json_write_object_end(w);
